document
  ...
  .addEventListener('click', function (e) {
    ...
    if (fullname.trim() === '') {
      ...
      efnameError.style.display = 'block'
      efnameError.textContent =
        'Full name cannot contain non-alphabetic characters.'
...
document.getElementById('editProfile').addEventListener('click', function (e) {
  ...
  if (
    editFullname.trim() === '' ||
    !namePattern.test(editFullname) ||
    editFullname.length < 3
  ) {
    ...
    editMobile.trim() === '' ||
    !mobilePattern.test(editMobile) ||
    editMobile === '0000000000'
  ) {
